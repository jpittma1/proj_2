...
pub_J1 = rospy.Publisher('/iiwa/PositionJointInterface_J1_controller/command', Float64, queue_size=10)     
pub_J2 = rospy.Publisher('/iiwa/PositionJointInterface_J2_controller/command', Float64, queue_size=10) 
pub_J3 = rospy.Publisher('/iiwa/PositionJointInterface_J3_controller/command', Float64, queue_size=10) 
pub_J4 = rospy.Publisher('/iiwa/PositionJointInterface_J4_controller/command', Float64, queue_size=10) 
pub_J5 = rospy.Publisher('/iiwa/PositionJointInterface_J5_controller/command', Float64, queue_size=10) 
pub_J6 = rospy.Publisher('/iiwa/PositionJointInterface_J6_controller/command', Float64, queue_size=10) 
pub_J7 = rospy.Publisher('/iiwa/PositionJointInterface_J7_controller/command', Float64, queue_size=10)
...
def talker():
    ...
    # #Joint 1, 3, 5, and 7 do a spin
    # # for i in range(0,360):
    # #     pub_J1.publish(d2r(i))
    # #     pub_J3.publish(d2r(i))
    # #     pub_J5.publish(d2r(i))
    # #     pub_J7.publish(d2r(i))
    # #     rate.sleep()

    # pub_J1.publish(0)

    # pub_J2.publish(0.785)
    # # for i in range(0,360):
    # #     rate.sleep()
    # pub_J3.publish(0)
    ...
    # rate.sleep()
    # rate.sleep()
    # pub_J2.publish(0.523599)
    # rate.sleep()
    # rate.sleep()
    # rate.sleep()
    # pub_J1.publish(0.174533)
    # rate.sleep()
    # rate.sleep()
    # rate.sleep()
    # pub_J2.publish(0.785)
    ...
    # rate.sleep()
    # rate.sleep()
    # pub_J2.publish(0.500)
    # rate.sleep()
    # rate.sleep()
    # rate.sleep()
    # pub_J6.publish(1.632)
    # rate.sleep()
    # rate.sleep()
    # rate.sleep()
    # pub_J3.publish(0)
    ...
    ##--Initial Trajectory Planning Code---
    global d_x,d_y
